    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Obx(() {
            final Map<DateTime, bool> monthlyUserEatingMap =
                controller.monthlyUserEatingMap;
            final List<String> appliedUsersOnFocusedDay =
                controller.getDailyAppliedUsers();
            return Column(
              children: [
                  ...
                  calendarBuilders: CalendarBuilders(
                    ...
                    defaultBuilder: (context, date, events) {
                      final bool hasAppliedOnDate =
                          monthlyUserEatingMap[MyDateUtils.onlyDates(date)]!;
                      return Padding(
